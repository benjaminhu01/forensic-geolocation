...
def summarize_cross_validation(inputs):
    ...
    area_cols = ['country', 'locality', 'administrative_area_level_1', 'administrative_area_level_2','administrative_area_level_3','administrative_area_level_4','administrative_area_level_5']
    ...
    for input_ in inputs:
        ...
        if df['seeds'].unique() == 'none':
            ...
            areas = ['over_country', 'over_locality', 'over_administrative_area_level_1', 'over_administrative_area_level_2','over_administrative_area_level_3','over_administrative_area_level_4','over_administrative_area_level_5']
